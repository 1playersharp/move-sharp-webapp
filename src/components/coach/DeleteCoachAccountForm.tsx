...
import { deleteCoachAccount } from "@/app/actions/profile";

// Typed-"delete" confirmation for permanent coach-account removal.
// Mirrors DeleteAccountForm on the player side. Server action
// re-validates the string so a crafted request can't bypass.

export function DeleteCoachAccountForm() {
