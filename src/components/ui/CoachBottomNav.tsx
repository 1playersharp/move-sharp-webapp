...
import { COACH_TABS, isTabActive } from "@/components/ui/nav-tabs";

// Mobile and tablet navigation for the coach shell. Hidden from lg up,
  ...
  return (
    ...
    >
      <ul className="shell-width flex items-stretch justify-around px-2 pt-2">
        {COACH_TABS.map((tab) => {
          const active = isTabActive(pathname, tab.href, "/coach");
          return (
