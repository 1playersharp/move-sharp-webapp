...
export const EXERCISES: ExerciseSeed[] = [
  ...
  // ---- Jump tests (progress-tracked) ---------------------------------
  {
    ...
    description: "Timed 10m from a standing start. The purest measure of the first-step acceleration a match actually asks for.",
    category: "speed_acceleration",
    contexts: ["home", "gym"],
    equipmentGym: "Two cones 10m apart, stopwatch or phone timer",
    equipmentHome: "Two markers 10m apart, stopwatch or phone timer",
    defaultPrescription: "3 × 10m from a standing start, full recovery — log the best",
    coachingCue: "Start still, no rocking. First three steps decide it.",
    pbMetricKey: "sprint-10m",
  },
  {
...

  {
    ...
    description: "Side-on to a wall, load the back hip, then sequence hips-to-chest-to-arms and throw the ball into the wall as hard as you can.",
    category: "core_antirotation",
    contexts: ["home", "gym"],
    equipmentGym: "Med ball + solid wall",
    equipmentHome: "Med ball or a part-filled bag + solid wall",
    defaultPrescription: "4 × 5 per side, full recovery",
    coachingCue: "Hips lead, arms finish. Every rep is a max-intent rep.",
  },
  {
    slug: "woodchop-gym",
    name: "DB Woodchop",
    description: "Diagonal chop with a dumbbell from high on one side to low on the other, resisting the twist through the middle.",
    category: "core_antirotation",
    contexts: ["gym"],
    equipmentGym: "Dumbbell or cable",
    defaultPrescription: "3 × 8 per side",
    coachingCue: "Ribs down. The arms travel, the spine doesn't.",
  },
  {
    slug: "woodchop-home",
    name: "Band Woodchop",
    description: "Diagonal chop against a band anchored high or low, resisting the twist through the middle.",
    category: "core_antirotation",
    contexts: ["home"],
    equipmentHome: "Resistance band anchored to a fence post or door",
    defaultPrescription: "3 × 8 per side",
    coachingCue: "Ribs down. The arms travel, the spine doesn't.",
  },
  {
    slug: "pike-walkout",
    name: "Pike Walkout",
    description: "From standing, hinge and walk the hands out to a long plank, then walk them back. Hamstrings, shoulders and a braced trunk in one movement.",
    category: "robustness_resilience",
    contexts: ["home", "gym"],
    equipmentGym: "None",
    equipmentHome: "None",
    defaultPrescription: "3 × 6 walkouts",
    coachingCue: "Ribs down the whole way out. Don't let the hips sag at the far end.",
  },
  {
    slug: "standing-pistol",
    name: "Standing Pistol Squat",
    description: "Single-leg squat with the free leg held out in front. The hardest test of single-leg strength and balance a player can do with no kit.",
    category: "contact_duel_strength",
    contexts: ["home", "gym"],
    equipmentGym: "Box or bench to regress to",
    equipmentHome: "A chair or step to regress to",
    defaultPrescription: "3 × 3–5 per leg",
    coachingCue: "Knee tracks over the middle toes. Regress to a box before you chase depth.",
  },
  {
    slug: "bicycle-situp",
    name: "Bicycle Sit-Ups",
    description: "Alternating elbow-to-opposite-knee with the legs cycling. Rotation under load, which is what a duel actually asks for.",
    category: "core_antirotation",
    contexts: ["home", "gym"],
    equipmentGym: "Mat",
    equipmentHome: "None",
    defaultPrescription: "3 × 20 total (10 per side)",
    coachingCue: "Slow and long. Turn through the ribs, not by yanking the neck.",
  },
  {
    slug: "side-plank",
    name: "Side Plank",
  ...
  // ================================================================
  {
    ...
    description: "Seated with both knees at 90°, rotating the hips side to side. Opens internal and external rotation together.",
    category: "robustness_resilience",
    contexts: ["home", "gym"],
    defaultPrescription: "3 × 8 per side",
    coachingCue: "Chest tall, move from the hips not the lower back. Stop where it pinches, not where it hurts.",
  },
  {
    slug: "half-kneeling-hip-flexor",
    name: "Half-Kneeling Hip Flexor Stretch",
    description: "Half-kneeling lunge position with a posterior pelvic tilt. Lengthens the front of the hip after sitting all day.",
    category: "robustness_resilience",
    contexts: ["home", "gym"],
    defaultPrescription: "3 × 30s per side",
    coachingCue: "Tuck the tailbone under first, then ease forward. Squeeze the back glute.",
  },
  {
    slug: "glute-bridge",
    name: "Glute Bridge",
    description: "Lying hip extension driving through the heels. The foundation for hip power and a healthy lower back.",
    category: "robustness_resilience",
    contexts: ["home", "gym"],
    equipmentHome: "Resistance band optional for added tension",
    defaultPrescription: "3 × 12, 2s hold at top",
    coachingCue: "Ribs down, squeeze the glutes at the top. Feel it in the glute, not the hamstring or lower back.",
  },
  {
    slug: "banded-clam",
    name: "Banded Clam",
    description: "Side-lying hip abduction against a band. Wakes up the glute medius that keeps the knee tracking on a cut.",
    category: "robustness_resilience",
    contexts: ["home", "gym"],
    equipmentGym: "Mini band",
    equipmentHome: "Mini band or resistance band",
    defaultPrescription: "3 × 15 per side",
    coachingCue: "Hips stacked and still — don't roll backwards to cheat the range.",
  },
  {
    slug: "knee-to-wall-ankle",
    name: "Knee-to-Wall Ankle Mobilisation",
    description: "Driving the knee over the toes towards a wall. The single best test and fix for ankle range.",
    category: "robustness_resilience",
    contexts: ["home", "gym"],
    defaultPrescription: "3 × 10 per side",
    coachingCue: "Heel stays glued down. Knee tracks over the middle toes, not inwards.",
  },
  {
    slug: "calf-raise",
    name: "Calf Raise",
    description: "Heel raise through full range, double or single leg. Builds the tendon stiffness that sprinting and landing demand.",
    category: "robustness_resilience",
    contexts: ["home", "gym"],
    equipmentGym: "Step and dumbbells to load",
    equipmentHome: "A step or stair",
    defaultPrescription: "3 × 12, slow down",
    coachingCue: "All the way up, all the way down. Three seconds lowering — that's where the work is.",
  },
  {
    slug: "open-book-rotation",
    name: "Open Book T-Spine Rotation",
    description: "Side-lying rotation opening the top arm across the body. Restores rotation to the mid-back.",
    category: "robustness_resilience",
    contexts: ["home", "gym"],
    defaultPrescription: "3 × 8 per side",
    coachingCue: "Knees stay stacked and down. Follow the hand with your eyes, breathe out as you open.",
  },
  {
    slug: "cat-cow",
    name: "Cat/Cow",
    description: "Four-point alternating spinal flexion and extension. Segment-by-segment warm-up for the whole spine.",
    category: "robustness_resilience",
    contexts: ["home", "gym"],
    defaultPrescription: "2 × 10 slow cycles",
    coachingCue: "Move one vertebra at a time. Inhale to arch, exhale to round.",
  },
  {
    slug: "wall-angel",
    name: "Wall Angel",
    description: "Back to the wall, arms sliding overhead while contact is kept. Posture work for shoulders that live in a slouch.",
    category: "robustness_resilience",
    contexts: ["home", "gym"],
    defaultPrescription: "3 × 10",
    coachingCue: "Lower back, upper back, hands and elbows stay on the wall. Small range done properly beats a big range cheated.",
  },
  {
    slug: "foot-doming",
    name: "Foot Doming",
    description: "Short-foot drill drawing the ball of the foot towards the heel without curling the toes. Builds the arch.",
    category: "robustness_resilience",
    contexts: ["home", "gym"],
    defaultPrescription: "3 × 10 per foot",
    coachingCue: "Toes stay long and flat. You're shortening the arch, not gripping with the toes.",
  },
  {
    slug: "chin-tuck-neck",
    name: "Chin Tuck + Neck Holds",
    description: "Deep neck flexor work with isometric holds. Neck strength matters for heading and for collisions.",
    category: "robustness_resilience",
    contexts: ["home", "gym"],
    defaultPrescription: "3 × 10s holds",
    coachingCue: "Make a double chin, don't nod. Gentle effort — this is endurance, not a max.",
  },
  {
    slug: "bird-dog",
    name: "Bird Dog",
    description: "Four-point opposite arm and leg extension. Teaches the trunk to stay still while the limbs move.",
    category: "robustness_resilience",
    contexts: ["home", "gym"],
    defaultPrescription: "3 × 8 per side",
    coachingCue: "Hips stay level — imagine balancing a glass of water on your lower back.",
  },
  {
    slug: "mobility-flow",
    name: "Mobility Flow",
